...
public class NeuralNetV2_Obsolete : MonoBehaviour
{

    public float[] hiddenLayerNodesArray;
    public float[] weightsArray;
    public float[] biasArray;
    public float[] MasterMindArray;

    static float[] inputNodesArray;
    public int[] hiddenLayersCount;
    static float[] outputNodesArray;
    static int activationFunctionType;
    ...
    //public NeuralNetV2(int nrOfInputs, int[] hiddenLayersArray, int nrOfOutputs, int activationFunctionNr)
    //{
    ...
    //    //hiddenLayerNodesArray = new float[CalculateNodesArrayCount()];//new float[3];//new float[CalculateNodesArrayCount()];//CalculateNodesArrayCount()
    //    //weightsArray = new float[CalculateWeightsCount()];//CalculateWeightsCount()
    //    //biasArray = new float[CalculateBiasArrayCount()];//CalculateBiasArrayCount()
    //    //MasterMindArray = new float[CalculateWeightsCount() + CalculateBiasArrayCount()];
    //}
    private void Awake()
    {
        //hiddenLayerNodesArray = new float[CalculateNodesArrayCount()];//new float[3];//new float[CalculateNodesArrayCount()];//CalculateNodesArrayCount()
        //weightsArray = new float[CalculateWeightsCount()];//CalculateWeightsCount()
        //biasArray = new float[CalculateBiasArrayCount()];//CalculateBiasArrayCount()
        //MasterMindArray = new float[CalculateWeightsCount() + CalculateBiasArrayCount()]; //CalculateWeightsCount() + CalculateBiasArrayCount() the whole thought process array length Weights + bias
    }

    public void InitializeNeuralNetwork(int nrOfInputs, int[] hiddenLayersArray, int nrOfOutputs, int activationFunctionNr)
    {
        //inpNdArrNr = nrOfInputs;
        //hdnNdArrNr = hiddenLayersArray;
        //outNodArrNr = nrOfOutputs;
        ...
        float[] inputNodesArray = new float[nrOfInputs]; // Nr of inputs
        int[] hiddenLayersCount = hiddenLayersArray; // number of hidden layers and nodes in them exp. [3,5] two layers: First layer 3 nodes, Second layer 5 nodes
        float[] outputNodesArray = new float[nrOfOutputs];
    ...
    //static float[] inputNodesArray = new float[inpNdArrNr]; // Nr of inputs
    ...
    //public float[] hiddenLayerNodesArray = new float[CalculateNodesArrayCount()];//new float[3];//new float[CalculateNodesArrayCount()];//CalculateNodesArrayCount()
